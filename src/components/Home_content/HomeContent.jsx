...
const Home_content = () => {
  ...
  const [myProfileEditData, setmyProfileEditData] =
    useState(defaulProfiletData);
  ...
  const [NewconfrenceData, setNewconfrenceData] = useState(
    NewconfrencedefaultData
  );
  ...
  function OnSubmitChangeDepartmentDetailMyProfile() {
    ...
    if (myid !== null) {
      axios
        .put(`${apilink}/faculty/${myid.key}`, myProfileEditData, {
          headers: {
  ...
  function postNewconfrence() {
    //will create new confrence with id of use and post to his id
    ...
    if (myid !== null) {
      axios
        .post(
          `${apilink}/confrences/`,
          { ...NewconfrenceData, faculty: myid.key },
          {
            headers: {
              Authorization: `token ${myid.token}`,
            },
  ...
  function postNewjournal() {
    ...
    if (myid !== null) {
      axios
        .post(
          `${apilink}/journals/`,
          { ...NewjournalData, faculty: myid.key },
          {
            headers: {
              Authorization: `token ${myid.token}`,
            },
  ...
  return (
    ...
    <div className="HomeContent">
      ...
      <div className="Publlicatons">
        <div className="publication">
          <div className="publication_image">
            <img
              src={
                "https://images.unsplash.com/photo-1543002588-bfa74002ed7e?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1374&q=80"
              }
              alt="..."
            />
          </div>
        ...
        <div className="publication">
          <div className="publication_image">
            <img
              src={
                "https://images.unsplash.com/photo-1507914997623-5b75b37d9cad?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=873&q=80"
              }
              alt="..."
            />
          </div>
      ...
      <MDBModal tabIndex="-1" show={editMyprofile} setShow={seteditMyprofile}>
        <MDBModalDialog centered>
          <MDBModalContent>
            <MDBModalHeader>
              <MDBModalTitle>
                Change your MyProfile details <br /> Error:{error}
              </MDBModalTitle>
              <MDBBtn
                className="btn-close"
                color="none"
            ...
            <MDBModalFooter>
              ...
              <MDBBtn onClick={OnSubmitChangeDepartmentDetailMyProfile}>
                Save changes
              </MDBBtn>
            </MDBModalFooter>
          </MDBModalContent>
      ...
      <MDBModal tabIndex="-1" show={addNewBook} setShow={setaddNewBook}>
        <MDBModalDialog centered>
          <MDBModalContent>
            <MDBModalHeader>
              <MDBModalTitle>
                Add New Book to your Publication <br /> Error:{error}
              </MDBModalTitle>
              <MDBBtn
                className="btn-close"
                color="none"
                onClick={toggleShowBookAdder}
              ></MDBBtn>
            </MDBModalHeader>
            <MDBModalBody>
              <form>
      ...
      <MDBModal
        tabIndex="-1"
        show={addNewconfrence}
        setShow={setaddNewconfrence}
      >
        <MDBModalDialog centered>
          <MDBModalContent>
            <MDBModalHeader>
              <MDBModalTitle>
                Add New confrence to your Publication <br /> Error:{error}
              </MDBModalTitle>
              <MDBBtn
                className="btn-close"
                color="none"
                onClick={toggleShowconfrenceAdder}
              ></MDBBtn>
            </MDBModalHeader>
            <MDBModalBody>
              <form>
                ...
                <div className="mb-3">
                  <MDBInput
                    value={NewconfrenceData.Proceeding}
                    onChange={popupAddconfrenceDataChange}
                    label="Proceeding"
                    id="typeNumber"
                    name="Proceeding"
      ...
      <MDBModal tabIndex="-1" show={addNewjournal} setShow={setaddNewjournal}>
        <MDBModalDialog centered>
          <MDBModalContent>
            <MDBModalHeader>
              <MDBModalTitle>
                Add New journal to your Publication <br /> Error:{error}
              </MDBModalTitle>
              <MDBBtn
                className="btn-close"
                color="none"
                onClick={toggleShowjournalAdder}
              ></MDBBtn>
            </MDBModalHeader>
            <MDBModalBody>
              <form>
